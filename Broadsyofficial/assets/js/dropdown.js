$(document).ready(function () {
    ...
    $(".sidebar_right_outer .res-submenu, .sidebar_right_outer .res-submenu, .accordion-item .faq-heading").on("click", function (e) {
        e.preventDefault();
        var $this = $(this);
    ...
    $(".shadow-form").each(function () {
        ...
        if (priceText.charAt(0) === "$") {
            ...
            if ($this.find(".toggle-price").length === 0) {
                $this.find(".boxed .text-h1").first().after('<div class="toggle-price svg-icon ml-sm"><img src="~/icons/close-eye.svg" alt="icon" width="40" height="40" class="price-hidden"></div>');
            }
        }
    });
    ...
    $(document).on("click", ".toggle-price", function (e) {
        ...
        if (isMasked) {
            ...
            $(".toggle-price img").attr("src", "/icons/open-eye.svg").attr("alt", "Show Price");
        } else {
            $(".shadow-form").each(function () {
                var $price = $(this).find(".text-h1");
                var originalPrice = $price.data("original-price");
            ...
            $(".toggle-price img").attr("src", "/icons/close-eye.svg").attr("alt", "Hide Price");
        }
    });
